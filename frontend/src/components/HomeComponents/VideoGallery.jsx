...
import { Play, Pause, Volume2, VolumeX, SkipBack, SkipForward, Clock, Calendar } from "lucide-react"

const getYoutubeThumbnail = (url) => {
  const videoId = url.split('embed/')[1]?.split('?')[0];
  return videoId ? `https://img.youtube.com/vi/${videoId}/maxresdefault.jpg` : '/api/placeholder/640/360';
}
...
const videos = [
  {
    ...
    duration: "3:24",
    date: "April 15, 2025",
    description: "Explore our beautiful campus facilities and academic environment in this exclusive tour."
  },
  {
    type: "youtube",
    ...
    date: "March 28, 2025",
    description: "Annual college events showcasing student talents, competitions, and celebrations."
  },
  {
    type: "youtube",
    ...
    date: "March 10, 2025",
    description: "Hear from our graduates about their journey to success and how the college helped them."
  },
  {
    type: "youtube",
    ...
    description: "Our distinguished faculty share insights about their research and teaching philosophies."
  },
  {
    type: "local",
    src: "https://csitdurg.in/Photos/csit_video.mp4",
    ...
    description: "Highlights from our biggest cultural festival of the year with performances and activities."
  },
  {
    type: "youtube",
    src: "https://www.youtube.com/embed/_tFRUefZKWo",
    ...
    description: "Tour our state-of-the-art laboratories and research facilities available to students."
  }
]
              ...
              {filteredVideos.map((video, idx) => (
                ...
                >
                  <div className="relative w-32 h-20 flex-shrink-0 rounded-lg overflow-hidden">
                    <img
                      src={video.type === "local" ? video.poster : video.thumbnail}
                      alt={video.title}
                      className="w-full h-full object-cover"
                    />
